              ...
              <div className="max-w-7xl mx-auto px-4 md:px-6">
                ...
                <section className="border-y border-heritage-gold/15 -mx-4 md:-mx-6 px-4 md:px-6 py-16 md:py-24 mb-0 bg-heritage-cream/40">
                  <div className="max-w-4xl mx-auto">
                    <span className="text-[11px] tracking-[0.35em] uppercase font-bold text-heritage-gold block mb-4">Il nostro approccio</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-10">
                      ...
                      <div className="border border-heritage-ink/10 bg-white rounded-2xl p-7 relative overflow-hidden">
                        ...
                        <p className="text-[15px] leading-relaxed text-heritage-ink/90 italic font-heritage">Alcuni oggetti hanno attraversato un secolo. Il loro prezzo riconosce la storia, la mano che li ha creati, il tempo che li ha resi unici.</p>
                      </div>
                      {/* Catawiki */}
                      <div className="border border-heritage-gold/25 rounded-2xl p-7 bg-heritage-gold/8 relative overflow-hidden">
                        ...
                        <p className="text-[15px] leading-relaxed text-heritage-ink/90 italic font-heritage mb-4">Alcuni pezzi di pregio vengono battuti all'asta su Catawiki, piattaforma europea per oggetti da collezione.</p>
                      ...
                      <div className="border border-heritage-ink/10 bg-white rounded-2xl p-7 relative overflow-hidden">
                        ...
                        <p className="text-[15px] leading-relaxed text-heritage-ink/90 italic font-heritage">Per questi non chiediamo nulla. Solo che finiscano nelle mani giuste — qualcuno che li faccia vivere ancora, come faceva papà.</p>
                      </div>
                    </div>
                  </div>
                </section>
                ...
                <section id="how-it-works" className="mt-20 md:mt-28 pt-12 md:pt-16 border-t border-heritage-ink/8">
                  <span className="text-[11px] tracking-[0.35em] uppercase font-bold text-heritage-gold block mb-4">Come funziona</span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-12">
                    {[
                      ...
                      <div key={i} className="flex flex-col gap-4">
                        ...
                        <p className="text-[13px] tracking-[0.25em] uppercase font-bold text-heritage-ink">{s.t}</p>
                        <p className="text-[15px] leading-relaxed text-heritage-ink/85 italic font-heritage">{s.b}</p>
                      </div>
                    ))}
                  </div>
                ...
                <section className="mt-20 md:mt-28 pt-12 md:pt-16 border-t border-heritage-ink/8">
                  <span className="text-[11px] tracking-[0.35em] uppercase font-bold text-heritage-gold block mb-4">La nostra storia</span>
                    ...
                    <div className="md:col-span-3 flex flex-col gap-8">
                      {[
                        ...
                        <div key={i}>
                          ...
                          <p className="text-[15px] leading-relaxed text-heritage-ink/90 italic font-heritage">{item.v}</p>
                ...
                <section className="mt-20 md:mt-28 -mx-4 md:-mx-6 px-4 md:px-6 py-16 md:py-24 bg-heritage-cream/60">
                  <div className="max-w-4xl mx-auto">
                    <span className="text-[11px] tracking-[0.35em] uppercase font-bold text-heritage-gold block mb-4">I ricordi di famiglia</span>
                ...
                <section className="mt-20 md:mt-28 pb-20 md:pb-28">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start">
                    <div>
                      <span className="text-[11px] tracking-[0.35em] uppercase font-bold text-heritage-gold block mb-4">Parliamoci</span>
                      ...
                      <p className="text-[15px] leading-relaxed text-heritage-ink/90 italic font-heritage mb-8">Non sei sicuro, vuoi vedere un oggetto dal vivo, o vuoi seguire un'asta su Catawiki? Ogni messaggio è il benvenuto. Rispondiamo entro poche ore.</p>
                      <a href="https://wa.me/393394468130" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-7 py-4 bg-[#25D366] text-white rounded-full text-[12px] font-bold tracking-[0.2em] uppercase">
